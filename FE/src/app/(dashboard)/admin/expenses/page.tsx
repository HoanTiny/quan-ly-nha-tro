...
import { AdminExpenseSummaryComponent } from '@/components/expenses/admin-expense-summary';
...
export default function AdminExpensesPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Tổng kết chi tiêu theo người"
        description="Xem chi tiết chi tiêu của từng thành viên trong nhà theo tháng."
      />
